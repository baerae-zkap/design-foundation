...
const CONTRAST_PAIRS = {
  light: [
    ...
    {
      text: "status.informational.content",
      textColor: "teal.50",
      surface: "status.informational.surface",
      surfaceColor: "teal.95",
      minRatio: 4.5,
      level: "AA normal",
    },
    {
      text: "status.cautionary.content",
      textColor: "orange.50",
      surface: "status.cautionary.surface",
      surfaceColor: "orange.95",
      minRatio: 3.0,
      level: "AA large",
    },
    {
      text: "status.positive.content",
      textColor: "green.50",
      surface: "status.positive.surface",
      surfaceColor: "green.95",
      minRatio: 4.5,
      level: "AA normal",
    },
    {
      text: "status.negative.content",
      textColor: "red.50",
      surface: "status.negative.surface",
      surfaceColor: "red.95",
      minRatio: 4.5,
      level: "AA normal",
    },
    ...
    {
      text: "component.button.primaryContent",
      textColor: "white",
      surface: "component.button.primarySurface",
