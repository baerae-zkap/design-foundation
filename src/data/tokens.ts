...
export const semanticColors = {
  light: {
    ...
    background: {
      primary: { value: palette.static.white, description: "기본 배경색. 대부분의 화면 바탕" },
      secondary: { value: palette.grey[100], description: "보조 배경색. 섹션 구분, 입력필드 배경" },
      accent: { value: palette.blue[50], description: "강조 배경색. 프로모션 영역" },
      disabled: { value: palette.grey[200], description: "비활성 영역, 스켈레톤 로딩" },
      grey: { value: palette.grey[100], description: "회색 배경. 리스트 사이 구분" },
      layered: { value: palette.static.white, description: "겹쳐진 레이어. 드롭다운, 메뉴" },
      floated: { value: palette.static.white, description: "떠있는 요소. FAB, 플로팅 버튼" },
      elevated: { value: palette.static.white, description: "높이감 있는 카드 배경" },
      sunken: { value: palette.grey[100], description: "움푹 들어간 영역. 인풋 필드 내부" },
    },
    text: {
      primary: { value: palette.grey[900], description: "가장 중요한 텍스트. 제목, 본문" },
      secondary: { value: palette.grey[700], description: "보조 텍스트. 설명문, 부제목" },
      tertiary: { value: palette.grey[500], description: "약한 텍스트. 힌트, 캡션" },
      muted: { value: palette.grey[400], description: "가장 약한 텍스트. 비활성 라벨" },
      onDark: { value: palette.static.white, description: "어두운 배경 위 기본 텍스트" },
      onDarkSecondary: { value: palette.grey[200], description: "어두운 배경 위 보조 텍스트" },
      onDarkTertiary: { value: palette.grey[300], description: "어두운 배경 위 약한 텍스트" },
    ...
    divider: {
      primary: { value: palette.grey[200], description: "기본 구분선. 리스트 아이템 사이" },
      strong: { value: palette.grey[300], description: "강한 구분선. 섹션 사이" },
      subtle: { value: palette.grey[100], description: "약한 구분선. 미세한 영역 분리" },
      focus: { value: palette.blue[500], description: "포커스 상태 보더" },
    },
    icon: {
      default: { value: palette.grey[400], description: "기본 아이콘. 네비게이션, 액션" },
      secondary: { value: palette.grey[500], description: "보조 아이콘. 정보성" },
      tertiary: { value: palette.grey[400], description: "약한 아이콘. 힌트, 데코" },
      disabled: { value: palette.grey[300], description: "비활성 아이콘" },
      colored: { value: palette.blue[500], description: "강조 아이콘. 선택됨, 활성" },
      white: { value: palette.static.white, description: "어두운 배경 위 아이콘" },
    },
    surface: {
      card: { value: palette.static.white, description: "카드 컴포넌트 배경" },
      modal: { value: palette.static.white, description: "모달/다이얼로그 배경" },
      sheet: { value: palette.static.white, description: "바텀시트 배경" },
      tooltip: { value: palette.grey[800], description: "툴팁 배경" },
      popover: { value: palette.static.white, description: "팝오버/드롭다운 배경" },
    },
    semantic: {
  ...
  dark: {
    ...
    background: {
      primary: { value: palette.grey[900], description: "다크모드 기본 배경" },
      secondary: { value: palette.grey[800], description: "다크모드 보조 배경" },
      accent: { value: palette.grey[700], description: "다크모드 강조 배경" },
      disabled: { value: palette.grey[600], description: "다크모드 비활성 영역" },
      grey: { value: palette.grey[800], description: "다크모드 회색 배경" },
      layered: { value: palette.grey[800], description: "다크모드 겹쳐진 레이어" },
      floated: { value: palette.grey[700], description: "다크모드 떠있는 요소" },
      elevated: { value: palette.grey[800], description: "다크모드 카드 배경" },
      sunken: { value: palette.static.black, description: "다크모드 움푹 들어간 영역" },
    },
    text: {
      primary: { value: palette.grey[50], description: "다크모드 기본 텍스트" },
      secondary: { value: palette.grey[200], description: "다크모드 보조 텍스트" },
      tertiary: { value: palette.grey[300], description: "다크모드 약한 텍스트" },
      muted: { value: palette.grey[400], description: "다크모드 가장 약한 텍스트" },
      onDark: { value: palette.grey[50], description: "다크모드 밝은 배경 위 텍스트" },
      onDarkSecondary: { value: palette.grey[200], description: "다크모드 밝은 배경 위 보조" },
      onDarkTertiary: { value: palette.grey[300], description: "다크모드 밝은 배경 위 약한" },
      placeholder: { value: palette.grey[500], description: "다크모드 플레이스홀더" },
      disabled: { value: palette.grey[600], description: "다크모드 비활성 텍스트" },
      link: { value: palette.blue[300], description: "다크모드 링크" },
      error: { value: palette.red[400], description: "다크모드 에러" },
      success: { value: palette.green[400], description: "다크모드 성공" },
    },
    divider: {
      primary: { value: palette.grey[800], description: "다크모드 기본 구분선" },
      strong: { value: palette.grey[700], description: "다크모드 강한 구분선" },
      subtle: { value: palette.grey[800], description: "다크모드 약한 구분선" },
      focus: { value: palette.blue[400], description: "다크모드 포커스 보더" },
    },
    icon: {
      default: { value: palette.grey[100], description: "다크모드 기본 아이콘" },
      secondary: { value: palette.grey[400], description: "다크모드 보조 아이콘" },
      tertiary: { value: palette.grey[500], description: "다크모드 약한 아이콘" },
      disabled: { value: palette.grey[700], description: "다크모드 비활성 아이콘" },
      colored: { value: palette.blue[400], description: "다크모드 강조 아이콘" },
      white: { value: palette.grey[50], description: "다크모드 밝은 배경 위 아이콘" },
    },
    surface: {
      card: { value: palette.grey[800], description: "다크모드 카드 배경" },
      modal: { value: palette.grey[700], description: "다크모드 모달 배경" },
      sheet: { value: palette.grey[800], description: "다크모드 바텀시트 배경" },
      tooltip: { value: palette.grey[600], description: "다크모드 툴팁 배경" },
      popover: { value: palette.grey[700], description: "다크모드 팝오버 배경" },
    },
    semantic: {
