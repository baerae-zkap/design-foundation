          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {[
                ...
                { name: 'title2XLarge', size: 36, lineHeight: 44, weight: 700, category: 'Title' },
                { name: 'titleExtraLarge', size: 32, lineHeight: 40, weight: 700 },
                { name: 'titleLarge', size: 28, lineHeight: 36, weight: 700 },
                { name: 'titleMedium', size: 24, lineHeight: 32, weight: 700 },
                { name: 'subtitleLarge', size: 20, lineHeight: 28, weight: 600, category: 'Subtitle' },
                { name: 'subtitleMedium', size: 18, lineHeight: 26, weight: 600 },
                { name: 'subtitleSmall', size: 16, lineHeight: 24, weight: 600 },
                { name: 'subtitleExtraSmall', size: 14, lineHeight: 20, weight: 600 },
