      ...
      <section className="mb-10">
        ...
        >
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {[
                { name: 'display.lg', size: 32, lineHeight: 40, weight: 700, category: 'Display' },
                { name: 'display.md', size: 28, lineHeight: 36, weight: 700 },
                { name: 'display.sm', size: 24, lineHeight: 32, weight: 700 },
                { name: 'title.t1', size: 36, lineHeight: 44, weight: 700, category: 'Title' },
                { name: 'title.t2', size: 32, lineHeight: 40, weight: 700 },
                { name: 'title.t3', size: 28, lineHeight: 36, weight: 700 },
                { name: 'title.t4', size: 24, lineHeight: 32, weight: 700 },
                { name: 'subtitle.st1', size: 20, lineHeight: 28, weight: 600, category: 'Subtitle' },
                { name: 'subtitle.st2', size: 18, lineHeight: 26, weight: 600 },
                { name: 'subtitle.st3', size: 16, lineHeight: 24, weight: 600 },
                { name: 'subtitle.st4', size: 14, lineHeight: 20, weight: 600 },
                { name: 'heading.lg', size: 24, lineHeight: 32, weight: 600, category: 'Heading' },
                { name: 'heading.md', size: 20, lineHeight: 28, weight: 600 },
                { name: 'heading.sm', size: 18, lineHeight: 26, weight: 600 },
                { name: 'body.xl', size: 18, lineHeight: 28, weight: 400, category: 'Body' },
                { name: 'body.lg', size: 16, lineHeight: 24, weight: 400 },
                { name: 'body.md', size: 14, lineHeight: 20, weight: 400 },
                { name: 'body.sm', size: 13, lineHeight: 18, weight: 400 },
                { name: 'body.xs', size: 12, lineHeight: 16, weight: 400 },
                { name: 'label.lg', size: 16, lineHeight: 24, weight: 500, category: 'Label' },
                { name: 'label.md', size: 14, lineHeight: 20, weight: 500 },
                { name: 'label.sm', size: 12, lineHeight: 16, weight: 500 },
                { name: 'numeric.xl', size: 32, lineHeight: 40, weight: 600, category: 'Numeric' },
                { name: 'numeric.lg', size: 24, lineHeight: 32, weight: 600 },
                { name: 'numeric.md', size: 18, lineHeight: 26, weight: 600 },
                { name: 'numeric.sm', size: 14, lineHeight: 20, weight: 600 },
