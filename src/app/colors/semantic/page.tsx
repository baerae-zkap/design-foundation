    ...
    <div style={{ marginBottom: 'var(--space-8)' }}>
      <div style={{ marginBottom: spacing.primitive[3] }}>
        <h3
          ...
          style={{ color: 'var(--content-base-strong)', marginBottom: spacing.primitive[1] }}
        >
          {title}
        </h3>
      ...
      >
        <div style={{ flex: 1, fontSize: typography.fontSize.xs, fontWeight: typography.fontWeight.medium, color: 'var(--content-base-secondary)' }}>
          Token
        </div>
        <div style={{
          display: 'flex',
