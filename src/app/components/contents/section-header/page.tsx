...
function SectionHeaderPlayground() {
  ...
  const trailing =
    ...
    trailingType === "icon" ? (
      <IconButton aria-label="More options" size="small" color="neutral" variant="ghost" onClick={() => {}}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="5" r="1.5" fill="currentColor"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="12" cy="19" r="1.5" fill="currentColor"/></svg>
      </IconButton>
    ) : undefined;
